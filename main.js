...
module.exports = "<div class=\"row h-100 w-100\">\n  <div class=\"col-2\">\n    <app-header></app-header>\n  </div>\n  <div class=\"col-10 page-content\">\n    <router-outlet></router-outlet>\n  </div>\n</div>\n"
...
module.exports = "<h2 class=\"tile\" *ngIf=\"data\">{{data.text}}</h2>\n<div class=\"comments-wrapper\">\n  <div class=\"comment\">\n    <div class=\"comment-container\" *ngFor=\"let comment of data.comments\">\n      <div class=\"row\">\n        <div class=\"col-1\">\n          <div class=\"avatar\"></div>\n        </div>\n        <div class=\"col-11\">\n          <p class=\"text\">\n            {{comment.description}}\n          </p>\n        </div>\n      </div>\n    </div>\n    <div class=\"new-comment-container\">\n      <div class=\"row\">\n        <div class=\"col-1\">\n          <div class=\"avatar\"></div>\n        </div>\n        <div class=\"col-11\">\n          <form class=\"form\" *ngIf=\"commentForm\" [formGroup]=\"commentForm\">\n            <textarea formControlName=\"description\" class=\"textarea\" (keydown.control.enter)=\"addComment()\"></textarea>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _model_data_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../model/data.model */ "./src/app/model/data.model.ts");
...
var CommentsComponent = /** @class */ (function () {
    function CommentsComponent(fb) {
        this.fb = fb;
        this.commentsData = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    CommentsComponent.prototype.ngOnInit = function () {
        this.createCommentForm();
    };
    CommentsComponent.prototype.createCommentForm = function () {
        this.commentForm = this.fb.group({
            description: [''],
        });
    };
    CommentsComponent.prototype.addComment = function () {
        var comment = this.commentForm.get('description');
        this.commentsData.emit(comment.value);
        comment.setValue('');
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _model_data_model__WEBPACK_IMPORTED_MODULE_1__["DataModel"])
    ], CommentsComponent.prototype, "data", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], CommentsComponent.prototype, "commentsData", void 0);
...
/***/ "./src/app/model/data.model.ts":
/*!*************************************!*\
  !*** ./src/app/model/data.model.ts ***!
  \*************************************/
/*! exports provided: CommentsModel, DataModel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CommentsModel = /** @class */ (function () {
    function CommentsModel(description) {
...
var DataModel = /** @class */ (function () {
    function DataModel(text, point, comments) {
        this.text = text;
        this.point = point;
...
/* harmony import */ var _components_comments_comments_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/comments/comments.component */ "./src/app/components/comments/comments.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
